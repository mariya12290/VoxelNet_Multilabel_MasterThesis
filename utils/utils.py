...
def label_to_gt_box3d(labels, cls='Car', coordinate='camera', T_VELO_2_CAM=None, R_RECT_0=None):
    ...
    if cls == 'Pedestrian':
        acc_cls = ['Pedestrian']
        print('Taking the pedestrian class labels: ', cls)
    elif cls == 'Cyclist':
        acc_cls = ['Cyclist']
        print('Taking the cyclist class labels: ', cls)
    else: # all
        acc_cls = []
        print('Taking another classes : ', cls)
...
def cal_anchors(ANCHOR_L):
    ...
    l = np.ones_like(cx) * ANCHOR_L   #different Anchor_L for pedestrian and cyclist 0.8 and 1.7
